...
@InputType()
class SessionCreateNestedManyWithoutMediaItemsInput {
...
export { SessionCreateNestedManyWithoutMediaItemsInput as SessionCreateNestedManyWithoutMediaItemsInput };
